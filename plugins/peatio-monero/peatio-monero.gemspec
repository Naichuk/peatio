...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Gem for extending Peatio plugable system with Monero implementation.}
  spec.description   = %q{Monero Peatio gem which implements Peatio::Blockchain::Abstract & Peatio::Wallet::Abstract.}
