...
describe Adjustment do
  ...
  subject { create(:adjustment, receiving_account_number: "btc-202-#{member.uid}") }
  ...
  context '#prebuild_operations' do
    ...
    context 'asset and liability' do
      let!(:adjustment) { create(:adjustment, receiving_account_number: "btc-202-#{member.uid}", amount: 1) }
    ...
    context 'asset and revenue' do
      let!(:adjustment) { create(:adjustment, receiving_account_number: "btc-302", amount: 1) }
    ...
    context 'asset and expense' do
      let!(:adjustment) { create(:adjustment, receiving_account_number: "btc-402", amount: 1) }
  ...
  context 'on accept' do
    ...
    context 'validate validator presene' do
